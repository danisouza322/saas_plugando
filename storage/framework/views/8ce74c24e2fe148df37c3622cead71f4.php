                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                            <img src="<?php if(Auth::user()->avatar != ''): ?> <?php echo e(URL::asset('storage/' . Auth::user()->avatar)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?> <?php endif; ?>"
                                class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                            <div class="avatar-xs p-0 rounded-circle profile-photo-edit">
                                <input id="profile-img-file-input" type="file" class="profile-img-file-input <?php $__errorArgs = ['avatar'];
...
unset($__errorArgs, $__bag); ?>" wire:model="avatar">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <p class="text-muted mb-0"><?php echo e(Auth::user()->empresa->nome); ?></p>
                    </div>
                </div>
            </div>
            <!--end card-->
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!--end row-->
</div><?php /**PATH C:\Users\Daniel\Documents\saas_plugando\resources\views/livewire/user/edit-profile.blade.php ENDPATH**/ ?>